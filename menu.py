...
font = pygame.font.Font('8-BIT_WONDER.TTF', 60)
font1 = pygame.font.Font('8-BIT_WONDER.TTF', 40)
font2 = pygame.font.Font('8-BIT_WONDER.TTF', 30)
font3 = pygame.font.Font('8-BIT_WONDER.TTF', 20)
font4 = pygame.font.Font('8-BIT_WONDER.TTF', 10)
ARROWS = pygame.transform.scale(pygame.image.load(os.path.join('arrows.png')), (100,200))
